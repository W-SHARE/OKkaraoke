class SearchController < ApplicationController
  ...
  def result
    ...
    #スプレッドシートからデータを読み込めているかのテスト用
    #@spreadsheetDataImportTest = resultPage2
    #@spreadsheetDataImportTestFirstElement = result["values"][1]
        ...
        if @begin_at_h < 18 #昼
            ...
            if classification == 'student' #学生
              if length == 180 #フリータイム
                if resultPage2["values"][i][10] == "TRUE" #ワンドリンク制
                  hash[:price] = resultPage1["values"][i][15].to_i * length30ary + 380
                else #飲み放題制
                  hash[:price] = resultPage1["values"][i][15].to_i * length30ary
                end
              else #通常利用
              ...
              if length == 180 #フリータイム
                if resultPage2["values"][i][11] == "TRUE" #ワンドリンク制
                  hash[:price] = resultPage1["values"][i][16].to_i * length30ary + 380
                else #飲み放題制
                  hash[:price] = resultPage1["values"][i][16].to_i * length30ary
                end
              else #通常利用
            ...
            if classification == 'student' #学生
              if length == 180 #フリータイム
                if resultPage2["values"][i][12] == "TRUE" #ワンドリンク制
                  hash[:price] = resultPage1["values"][i][17].to_i * length30ary + 380
                else #飲み放題制
                  hash[:price] = resultPage1["values"][i][17].to_i * length30ary
                end
              else #通常利用
              ...
              if length == 180 #フリータイム
                if resultPage2["values"][i][13] == "TRUE" #ワンドリンク制
                  hash[:price] = resultPage1["values"][i][18].to_i * length30ary + 380
                else #飲み放題制
                  hash[:price] = resultPage1["values"][i][18].to_i * length30ary
                end
              else #通常利用
          ...
          if 1 <= day <= 5 #平日
            if classification == 'student' #学生
              if length == 180 #フリータイム
                if resultPage2["values"][i][10] == "TRUE" #ワンドリンク制
                  hash[:price] = resultPage1["values"][i][19].to_i * length30ary + 380
                else #飲み放題制
                  hash[:price] = resultPage1["values"][i][19].to_i * length30ary
                end
              else #通常利用
              ...
              if length == 180 #フリータイム
                if resultPage2["values"][i][11] == "TRUE" #ワンドリンク制
                  hash[:price] = resultPage1["values"][i][20].to_i * length30ary + 380
                else #飲み放題制
                  hash[:price] = resultPage1["values"][i][20].to_i * length30ary
                end
              else #通常利用
            ...
            if classification == 'student' #学生
              if length == 180 #フリータイム
                if resultPage2["values"][i][12] == "TRUE" #ワンドリンク制
                  hash[:price] = resultPage1["values"][i][21].to_i * length30ary + 380
                else #飲み放題制
                  hash[:price] = resultPage1["values"][i][21].to_i * length30ary
                end
              else #通常利用
              ...
              if length == 180 #フリータイム
                if resultPage2["values"][i][13] == "TRUE" #ワンドリンク制
                  hash[:price] = resultPage1["values"][i][22].to_i * length30ary + 380
                else #飲み放題制
                  hash[:price] = resultPage1["values"][i][22].to_i * length30ary
                end
              else #通常利用
